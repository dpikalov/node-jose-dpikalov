...
function JWEEncrypter(cfg, fields, recipients) {
  ...
  Object.defineProperty(this, "final", {
    value: function(data, encoding) {
      ...
      // encrypt plaintext
      promise = promise.then(function(jwe) {
        // see step 14 of https://datatracker.ietf.org/doc/html/rfc7516#section-5.1
        // normally, adata should include headers, but we allow to change this behavior
        if (cfg.excludeHeaderFromAad) {
          props.adata = undefined
        } else {
...
function createEncrypt(opts, rcpts) {
  ...
  var cfg = {
    ...
    excludeHeaderFromAad: options.excludeHeaderFromAad,
  };
